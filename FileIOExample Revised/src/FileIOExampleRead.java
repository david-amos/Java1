...
public class FileIOExampleRead {
    ...
    static String[] arrDeptNames = {"Marketing", "Sales", "Accounting", "Support", "IT", "Management", "Janitorial"};
    //Initializer list
    ...
    public static void output(){
        pw.format("%-25s%5s%-25s%5s%-10s%5s%5d%5s%5.2f%5s%10.2f%n%n", iFirstName, " ", iLastName, " ", arrDeptNames[iDept - 1], " ",
                iHours, " ", iRate, " ", cPay);
    }
